...
//Todo Date and Time
  ...
  return (
<div className="w-full h-screen flex justify-center items-center overflow-hidden mt-0 bg-slate-400">
<div className='bg-slate-400 w-11/12 h-full place-self-center max-w-4xl flex flex-col p-2 min-h-[450px] rounded-xl'>
 {/* --------title------------ */}
